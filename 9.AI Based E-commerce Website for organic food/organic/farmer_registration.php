...
include "db.php";
	...
	$sql="INSERT INTO farmers(f_name,email,mobile,gender,password,certificate,user_activation_code,user_email_status)VALUES('$f_name','$email','$mobile','$gender','$password','$certificate','$user_activation_code','$user_email_status')";
		...
		if(isset($sql))
		{
			...
			<p>Please Open this link to verified your email address - ".$base_url."email_verification_farmer.php?activation_code=".$user_activation_code."
			...
			$msg = "Thanks for Registration. Kindly verify your Email and Enjoy Selling. ";
