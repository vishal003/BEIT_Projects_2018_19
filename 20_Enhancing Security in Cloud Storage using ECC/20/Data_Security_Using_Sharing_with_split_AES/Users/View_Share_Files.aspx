                ...
                <div class="main">
                    ...
                    <div class="content">
                                ...
                                <td style="text-align: right;">
                                    <p style="margin-right: 100px">
                                        ...
                                        &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*"
                                            ControlToValidate="txtSearchQuery" Font-Size="Large" ForeColor="Red" 
                                            ToolTip="Empty Field"></asp:RequiredFieldValidator>
                                        <asp:Button ID="btnSearch" runat="server" Text="Search" Height="30px" 
                                            onclick="btnSearch_Click" Width="75px" />
                                    </p>
                                </td>
                            </tr>
                        </table>
                        ...
                        <asp:GridView Width="100%" ID="GridView1" runat="server"  AllowSorting="True"
                            AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" PageSize="100">
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField DataNavigateUrlFields="share_id" DataNavigateUrlFormatString="frmMatchHash.aspx?share_id={0}"
