<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Share_Log.aspx.cs" Inherits="Admin_Share_Log" %>
        ...
        <div class="page-in">
            <div class="page">
                <div class="main">
                    ...
                    <div class="content">
                        <h3>
                            <a href="Share_File.aspx">Share File</a></h3>
                        <br />
                        <asp:GridView Width="100%" ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="cloud_id" HeaderText="cloud_id" 
                                    SortExpression="cloud_id" >
                                <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                            </Columns>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbConnection %>"
                            SelectCommand="SELECT * FROM [Share_Master]"></asp:SqlDataSource>
                    </div>
